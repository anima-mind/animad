...
// Blueprint: https://github.com/joshuamoreno1/anima (spec doc 03, perfil server §A.5).
//
...
func main() {
	...
	fmt.Fprintln(os.Stderr, "animad: daemon not implemented yet — blueprint at https://github.com/joshuamoreno1/anima")
	os.Exit(1)
}
